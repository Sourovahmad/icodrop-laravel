    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="descs">
                    <p>ICO Drops is an independent ICO (Token Sale) database and is not affiliated with any ICO project or company. Our Interest Level does not constitute financial or investment advice.</p>
                </div>
                <div class="descs">
                ...
                <div class="descs">
                    <p>© 2021 ICO Drops.© 2021 ICO Drops.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <ul class="page-links">
                    <li><a href="">ACTIVE ICO</a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <ul class="page-links">
                    ...
                    <li><a href="">TELEGRAM CHAT</a></li>
                    <li><a href="">TELEGRAM CHAT(RU)</a></li>
                    <li><a href="">DROPSERN CHAT(RU)</a></li>
                </ul>
            </div>
        </div>
    </div>
